...
\begin{myAssumption}\label{Ass:noRemove}
	$\W$ only models the {\em addition} of propositions as a result of new elements of the open world. That is, $AP_{k} \subset AP_{k+1}$. In other words, once added, propositions are never removed. Hence, \emph{expanding} open world model.
\end{myAssumption}
