...
Finally, we will define a function $\mathcal{C}: AP_t \rightarrow 2^{AP_t}$, which takes in an atomic proposition and returns the set of propositions that it has been defined to correspond to, where $2^{AP}$ denotes the power set of $AP$. 
