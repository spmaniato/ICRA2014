...
%Furthermore, the aforementioned approaches assume that the size of the workspace is known, i.e., that only its internal structure changes. 
...
%In addition, they do not account for augmenting the mission with additional objectives, a situation that may arise if the robot can discover new regions or objects of interest. 
