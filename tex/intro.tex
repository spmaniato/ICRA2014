...
\begin{figure}[t]
	...
	\caption{Above is our implementation of a mailbot. A Nao humanoid robot is mounted on a Segway platform that includes a Lidar sensor. The actuation and perception capabilities of the Nao are complemented by the localization, navigation and mobility advantages of the Segway.}
	\label{Fig:mailbot}
\end{figure}
