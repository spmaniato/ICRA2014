...
\title{\LARGE \bf
Higher Level Abstractions for Provably Correct Robot Planning: Application to Synthesis for Open-worlds
}
...
Check LTL: $\X \G \F \Cox$This electronic document is a ÒliveÓ template. The various components of your paper [title, text, heads, etc.] are already defined on the style sheet, as illustrated by the portions given in this document.
